...
export async function POST(req: NextRequest) {
  try {
    ...
    // sprawdzenie czy recipient istnieje
    ...
    // sprawdzenie czy nie probuje wyslac do siebie
    ...
    // sprawdzenie czy konwersacja juz istnieje
    ...
    if (conversation) {
      ...
      // usuwanie z deletedBy jeśli user wczesniej usunal
